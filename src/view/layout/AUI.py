...
from src.view.HistoryListPanel import HistoryGrid
...
##        view_menu.Append(ID_SwitchPane, _("S&witch Window...") + "\t" + switcherAccel)
    ...
    def BuildPanes(self):
        ...
        self._mgr.AddPane(self.CreateTreeCtrl(), aui.AuiPaneInfo().Name("test8").Caption("Tree Pane").
                          ...
                          MinimizeButton(True))
        self._mgr.AddPane(self.CreateTreeCtrl(), aui.AuiPaneInfo().Name("test111111").Caption("Tree Pane").
                          Left().Layer(2).Position(2).CloseButton(True).MaximizeButton(True).
                          MinimizeButton(True), target=self._mgr.GetPane("test8"))
        ...
        self._mgr.AddPane(self.sqlConsoleOutputPane(), aui.AuiPaneInfo().
