...
###############################################################################
from src.view.util.syntax.synglob import LANG_MAP
...
class SyntaxMgr(object):
    ...
    def GetSyntaxData(self, ext):
        ...
        lex_cfg = LANG_MAP.get(lang, LANG_MAP[LANG_TXT])
...
class SynExtensionDelegate(SyntaxDataBase):
    ...
    def __init__(self, xml_obj):
        ...
        SyntaxDataBase().__init__(self, langId)
